...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FourthFragment(), "Thursday");
        adapter.addFragment(new FifthFragment(), "Firday");
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://ua.pp.danielyuzek.simple_schedule/http/host/path")
        );
